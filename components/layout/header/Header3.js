                        ...
                        <div className="row">
                            <div className="col-xl-7 col-lg-12 col-md-12 ">
                                <div className="header-welcome-text">
                                    <span>The brand for corpers wears </span>
                                </div>
                            </div>
                                ...
                                <div className="cat-menu__category p-relative">
                                    ...
                                    <div className="category-menu" style={{ display: `${isToggled ? "block" : "none"}` }}>
                                        <ul className="cat-menu__list">
                                            <li><Link href="/shop-2"><i className="fal fa-chair" /> FLASHLIGHT</Link></li>
                                            
                                            <li><Link href="/shop-2"><i className="fal fa-shoe-prints" />SUN SHADES</Link></li>
                                            <li><Link href="/shop-2"><i className="fal fa-shoe-prints" />TOWELS</Link></li>
                                            <li><Link href="/shop-2"><i className="fal fa-tshirt" />SINGLETS</Link></li>
                                            <li><Link href="/shop-2"><i className="fal fa-clock" />CARD HOLDER</Link></li>
                                            <li><Link href="/shop-2"><i className="fal fa-light-ceiling" />SOCKS</Link></li>
                                            <li><Link href="/shop-2"><i className="fal fa-gift" />WATER BOTTLE</Link></li>
                                            <li><Link href="/shop-2"><i className="fal fa-basketball-ball" />BAGS</Link></li>
                                            <li><Link href="/shop-2"><i className="fal fa-gift" />SHOES</Link></li>
                                            <li><Link href="/shop-2"><i className="fal fa-lightbulb-dollar" />SHORTS</Link></li>
                                            <li><Link href="/shop-2"><i className="fal fa-car-alt" />T-SHIRTS</Link></li>
                                        </ul>
