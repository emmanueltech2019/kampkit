            ...
            <footer>
                <div className="footer-area secondary-footer black-bg-2 pt-65">
                    <div className="container">
                        <div className="main-footer pb-5 mb-5">
                            <div className="row">
                                <div className="col-lg-3 col-md-4 col-sm-6">
                                    <div className="footer-widget footer-col-1 mb-40">
                                        <div className="footer-logo mb-30">
                                            <Link href="/"><img src="https://res.cloudinary.com/wise-solution-inc/image/upload/v1748071840/Screenshot_2025-05-24_at_08.28.43-removebg-preview_pso4ph.png" width='300' alt="logo" /></Link>
                                        </div>
                                        <div className="footer-content">
                                            <p>A Fashion and design brand situated in Lagos Nigeria, The Kampits brand is targeted at fresh graduate. who are enrolling in the Youth Service Corps. </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-3 col-md-4 col-sm-6">
                            ...
                            <div className="row align-items-center">
                                <div className="col-xl-6 col-lg-7 col-md-5">
                                    <div className="footer-copyright__content">
                                        <span>Copyright {new Date().getFullYear()} <Link href="/">©KampKits</Link>. All rights reserved. Developed by <Link href="https://thisisvine.com/"> Vine Africa</Link>.</span>
                                    </div>
                                </div>
